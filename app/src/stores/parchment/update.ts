...
interface State extends UpdateState<Parchment> {}

export const useParchmentUpdateStore = defineStore("parchmentUpdate", {
  state: (): State => ({
    updated: undefined,
    retrieved: undefined,
    isLoading: false,
  ...
  actions: {
    ...
    async update(payload: Parchment) {
      this.setError("");
      this.toggleLoading();
